...
local mod = core:NewBoss("DS_SystemDaemons", 52)
...
mod:RegisterRestrictZone("DS_SystemDaemons", "Halls of the Infinite Mind", "Infinite Generator Core", "Lower Infinite Generator Core")
mod:RegisterEnableZone("DS_SystemDaemons", "Halls of the Infinite Mind", "Infinite Generator Core", "Lower Infinite Generator Core")
mod:RegisterRestrictEventObjective("DS_SystemDaemons", "Defeat the System Daemons")
mod:RegisterEnableEventObjective("DS_SystemDaemons", "Defeat the System Daemons")
